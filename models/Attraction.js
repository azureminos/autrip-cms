...
Attraction.add({
	...
	descIncluded: { type: Types.Textarea },
	descSchedule: { type: Types.Textarea },
	descWhatToExpect: { type: Types.Textarea },
	descAddInfo: { type: Types.Textarea },
	descCancelPolicy: { type: Types.Textarea },
	descFreqQA: { type: Types.Textarea },
	...
	type: { type: Types.Select, options: 'Landmark, Tour', default: 'Landmark' },
