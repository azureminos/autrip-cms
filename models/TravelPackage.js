...
TravelPackage.add({
	...
	image: { type: Types.CloudinaryImage, folder: 'Packages' },
	titleImage: { type: Types.CloudinaryImage, folder: 'Packages' },
	carouselImages: { type: Types.CloudinaryImages, folder: 'Packages' },
...
TravelPackage.schema.methods.cleanupCountry = function (callback) {
	...
	keystone
		.list('Country')
		.model.findOne({ packages: pkg._id })
		.exec(function (err, item) {
			if (err || !item) return callback();
			if (
				!pkg.country
				|| (pkg.country && item._id.toString() != pkg.country.toString())
			) {
...
TravelPackage.schema.methods.updateCountry = function (callback) {
	...
	if (pkg.country) {
		...
		keystone
			.list('Country')
			.model.findById(pkg.country.toString())
			.exec(function (err, item) {
				if (err || !item) return callback();
		...
		[
			function (callback) {
				if (travelPackage.isModified('country')) {
					console.log(
						'>>>>travelPackage.country changed, calling travelPackage.cleanupCountry'
					);
			...
			function (callback) {
				if (travelPackage.isModified('flightRates')) {
					console.log(
						'>>>>travelPackage.flightRates changed, calling travelPackage.cleanupFlightRates'
					);
			...
			function (callback) {
				if (travelPackage.isModified('flightRates')) {
					console.log(
						'>>>>travelPackage.flightRates changed, calling travelPackage.updateFlightRates'
					);
			...
			function (callback) {
				if (travelPackage.isModified('packageRates')) {
					console.log(
						'>>>>travelPackage.packageRates changed, calling travelPackage.cleanupPackageRates'
					);
			...
			function (callback) {
				if (travelPackage.isModified('packageRates')) {
					console.log(
						'>>>>travelPackage.packageRates changed, calling travelPackage.updatePackageRates'
					);
			...
			function (callback) {
				if (travelPackage.isModified('packageItems')) {
					console.log(
						'>>>>travelPackage.packageItems changed, calling travelPackage.cleanupPackageItems'
					);
			...
			function (callback) {
				if (travelPackage.isModified('packageItems')) {
					console.log(
						'>>>>travelPackage.packageItems changed, calling travelPackage.updatePackageItems'
					);
			...
			function (callback) {
				if (travelPackage.isModified('packageHotels')) {
					console.log(
						'>>>>travelPackage.packageHotels changed, calling travelPackage.cleanupPackageHotels'
					);
			...
			function (callback) {
				if (travelPackage.isModified('packageHotels')) {
					console.log(
						'>>>>travelPackage.packageHotels changed, calling travelPackage.updatePackageHotels'
					);
